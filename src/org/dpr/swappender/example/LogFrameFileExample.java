 ...
 * 
 */
public class LogFrameFileExample extends JFrame {
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				LogFrameFileExample frame = new LogFrameFileExample();

				frame.init();
				frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
				File f = new File(
						"C:\\Users\\Buck\\workspace\\Stefi\\log\\infoClient.log");
				frame.getLogPanel().getTableLog().appendFile(f, "%d|%p|%m");
			}
		});
	...
	protected void init() {
		...
		LogPanelAppender appender2 = new LogPanelAppender(layout, panelLog);
